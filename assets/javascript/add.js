(() => {
              ...
              (i._invoke = (function (t, r, e) {
                ...
                return function (o, i) {
                  ...
                  for (e.method = o, e.arg = i; ; ) {
                    ...
                    var u = f(t, r, e);
                    if ("normal" === u.type) {
                      if (((n = e.done ? d : p), u.arg === v)) continue;
  ...
  (e.n = (t) => {
    ...
    (() => {
      ...
      e(760);
      var n = document.getElementById("write_form");
      function o() {
        return (o = r(
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        r.preventDefault(),
                        (t.prev = 1),
                        (e = document.getElementById("title_write").value),
                        (n = document.getElementById("writer_write").value),
                        (o = document.getElementById("password_write").value),
                        (i = document.getElementById("content_write").value),
                        (t.next = 8),
                        fetch("/post/add", {
                          method: "POST",
                    ...
                    case 11:
                      ...
                      return t.abrupt("return", (window.location.href = "/"));
                    case 16:
                      t.next = 21;
                      break;
                    case 18:
                      (t.prev = 18), (t.t0 = t.catch(1)), console.log(t.t0);
                    case 21:
                    case "end":
                      return t.stop();
                  }
